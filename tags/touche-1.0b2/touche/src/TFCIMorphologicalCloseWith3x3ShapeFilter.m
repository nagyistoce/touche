//
//  TFCIMorphologicalCloseWith3x3ShapeFilter.m
//  Touche
//
...
@implementation TFCIMorphologicalCloseWith3x3ShapeFilter

+ (void)initialize
{
	[CIFilter registerFilterName:@"TFCIMorphologicalCloseWith3x3ShapeFilter"
					 constructor:self
				 classAttributes:[NSDictionary dictionaryWithObjectsAndKeys:
								  TFLocalizedString(@"3x3CloseName", @"3x3CloseName"),
